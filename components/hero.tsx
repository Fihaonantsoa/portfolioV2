  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Droite — Photo avec cercle animé ── */}
        <motion.div
        ...
        >
          <div className="relative w-64 h-64 sm:w-72 sm:h-72 lg:w-80 lg:h-80">
            ...
            {/* 🌟 Cercle animé qui parcourt la bordure */}
            <motion.svg
            ...
            {/* Photo */}
            <div className="absolute inset-4 rounded-full overflow-hidden border-4 border-background shadow-xl z-20">
            ...
            <motion.div
              ...
              className="absolute -bottom-2 -right-2 bg-accent text-accent-foreground px-3 py-1.5 rounded-full text-xs font-semibold shadow-lg z-30"
            >
