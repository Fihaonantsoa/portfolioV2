...
interface Project {
  ...
  tags: string[]
  media: ProjectMedia
  github?: string      // Frontend
  githubBack?: string  // Backend
  live?: string
  isPrivate?: boolean
  featured?: boolean
  status_fr: string
...
const projects: Project[] = [
  // ⭐ PROJET PHARE : STAGECONNECT
  {
    id: 0,
    title: "StageConnect – Plateforme de gestion de stages",
    title_en: "StageConnect – Internship Management Platform",
    description:
      "Plateforme web complète de mise en relation entre candidats et entreprises pour la gestion des stages. API REST Python (FastAPI) avec frontend Next.js. Gestion des offres, candidatures, entretiens, messagerie et notifications.",
    description_en:
      "Comprehensive web platform connecting candidates and companies for internship management. Python REST API (FastAPI) with a Next.js frontend. Offers, applications, interviews, messaging, and notifications management.",
    tags: ["Python", "FastAPI", "Next.js", "PostgreSQL", "TypeScript"],
    media: {
      type: "slides",
      sources: [
        "/images/Accueil.png",
        "/images/dashboardEtudiant.png",
        "/images/dashboardEntreprise.png",
      ],
    },
    github: "https://github.com/Fihaonantsoa/front_next_stageconnect",
    githubBack: "https://github.com/Fihaonantsoa/back_stageconnect",
    featured: true,
    status_fr: "Projet phare",
    status_en: "Featured project",
  },
  ...
  // Autres projets
  {
    ...
    description:
      "Application web de gestion de mobile money avec JSP, Servlet et MySQL. Gestion des envois, retraits, frais, génération PDF et notifications par email.",
    description_en:
      "Web application for mobile money management with JSP, Servlet and MySQL. Manage transfers, withdrawals, fees, PDF generation and email notifications.",
    ...
    github: "https://github.com/Fihaonantsoa/MobileMoney",
  ...
  },
  {
    ...
    description:
      "Application mobile React Native pour le suivi des ventes et de la gestion des stocks. Projet confidentiel pour un client.",
    description_en:
      "React Native mobile application for sales tracking and inventory management. Confidential project for a client.",
  ...
  },
  {
    ...
    description:
      "Application web de gestion des fichiers d'enquête, adaptée à la hiérarchie administrative de Madagascar (national, régional, communal, ...)",
    description_en:
      "Web application for managing survey files, designed to align with Madagascar's administrative hierarchy (national, regional, communal levels)",
  ...
  },
  {
    ...
    description:
      "Application web de gestion et de suivi des paiements d'eau et d'électricité. Développée en PHP avec une interface moderne Bootstrap.",
    description_en:
      "Web application for managing and tracking water and electricity payments. Built with PHP and a modern Bootstrap interface.",
  ...
  },
  {
    ...
    description:
      "Application desktop de gestion d'emploi du temps avec Java Swing et PostgreSQL. Interface intuitive pour la planification et le suivi des cours.",
    description_en:
      "Desktop application for schedule management with Java Swing and PostgreSQL. Intuitive interface for course planning and tracking.",
  ...
  },
  {
    ...
    description:
      "Application web de location automobile avec VueJs et MySQL. Interface moderne pour la gestion des véhicules, des réservations et des clients.",
    description_en:
      "Web application for car rental management with VueJs and MySQL. Modern interface for managing vehicles, reservations and customers.",
  ...
  },
  {
    ...
    description:
      "Application de surveillance et de suivi de l'état du système, avec visualisation des métriques en temps réel",
    description_en:
      "Desktop application for system health monitoring and tracking, featuring real-time metrics visualization",
...
function ProjectCard({
  ...
  return (
    <motion.div
      ...
      className="group flex flex-col rounded-2xl overflow-hidden transition-all duration-300 h-full"
      style={{
        background: 'var(--color-card, white)',
        border: isFeatured ? '1px solid rgba(139,92,246,0.3)' : '0.5px solid rgba(0,0,0,0.08)',
        boxShadow: isFeatured
          ? '0 4px 24px rgba(139,92,246,0.12), 0 1px 3px rgba(0,0,0,0.06)'
      ...
      whileHover={{
        y: -3,
        boxShadow: isFeatured
          ? '0 12px 40px rgba(139,92,246,0.2), 0 2px 8px rgba(0,0,0,0.08)'
          : (isMobile
            ? '0 8px 32px rgba(139,92,246,0.12), 0 2px 8px rgba(0,0,0,0.08)'
            : '0 8px 32px rgba(0,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06)'),
        borderColor: isFeatured
          ? 'rgba(139,92,246,0.5)'
          : (isMobile ? 'rgba(139,92,246,0.25)' : 'rgba(0,0,0,0.14)'),
      }}
    >
          ...
          <div className="flex items-center gap-2">
            <span
              ...
              style={{
                background: isFeatured
                  ? '#8b5cf6'
                  : (isPrivate ? '#f59e0b' : (isMobile ? '#a78bfa' : '#34d399')),
                boxShadow: isFeatured
                  ? '0 0 0 2px rgba(139,92,246,0.2), 0 0 8px rgba(139,92,246,0.4)'
                  : (isPrivate
            ...
            <span
              ...
              style={{
                ...
                color: isFeatured
                  ? '#7c3aed'
                  : (isPrivate ? '#d97706' : (isMobile ? '#7c3aed' : '#059669')),
              }}
            >
              {status}
            </span>
          ...
          {project.tags.map((tag) => (
            <span
              ...
              style={{
                ...
                color: isFeatured
                  ? '#6d28d9'
                  : (isPrivate ? '#d97706' : (isMobile ? '#6d28d9' : '#047857')),
                border: `0.5px solid ${isFeatured
